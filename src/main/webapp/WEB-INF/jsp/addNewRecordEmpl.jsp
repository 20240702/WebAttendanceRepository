...
<body>
    <div class="container">
        ...
        <form action="EmployeesMainServlet" method="post">
            ...
            <input type="date" name="atteRecord" id="atteRecord" required>
            ...
            <input type="text" name="atteRemarks" id="atteRemarks">

            <input type="hidden" name="process" value="insertNewAtte">
            <input type="submit" value="決定">
        </form>
        <a href="EmployeesMainServlet" class="cancel-button">キャンセル</a>
        <div class="footer">
            © OKOCHI 2024
        </div>
    </div>

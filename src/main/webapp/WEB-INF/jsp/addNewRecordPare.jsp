...
<body>
    <div class="container">
        ...
        <form action="ParentsMainServlet" method="post">
            <label for="beloGrade">学年:</label>
            <select name="beloGrade" id="beloGrade">
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            </select>

            <label for="beloClass">クラス:</label>
            <select name="beloClass" id="beloClass">
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            </select> 

            <label for="studCode">出席番号:</label>
            <select name="studCode" id="studCode">
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            ...
            <label for="atteRecord">日付:</label>
            <input type="date" name="atteRecord" id="atteRecord">
            ...
            <input type="time" name="atteArriTime" value="00:00" id="arriTime">

            <label for="depaTime">下校時刻:</label>
            <input type="time" name="atteDepaTime" value="00:00" id="depaTime">

            <label for="inf">出欠詳細情報:</label>
            <select name="atteInf" id="inf">
            ...
            <input type="text" name="atteRemarks">

            <input type="hidden" name="process" value="insertNewAtte"> 
